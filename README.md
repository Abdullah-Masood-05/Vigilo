...
- **Linux** — pre-built installers are available for the three main distributions:
  ...
  Linux installers for Debian/Ubuntu and Fedora are built through the GitHub Actions CI workflow. Arch Linux packages are documented in the repository but built separately.
